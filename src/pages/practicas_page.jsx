      ...
      <Wrapper titulo="Práctica Industrial" estado="En proceso"> 
        <section className='practicas-page__industrial'>
          <nav className='practicas-page__nav'>
            <Button text="Información general" onClick={() => alert("Funcionalidad fuera del alcance de nuestro campo de trabajo. que se sale de nuestro conocimiento de trabajo")} estado={true}/>
            <Button text="Bitácoras" onClick={() => alert("Funcionalidad fuera del alcance de nuestro campo de trabajo. que se sale de nuestro conocimiento de trabajo")} estado={false}/>
            <Button text="Informe" onClick={() => alert("Funcionalidad fuera del alcance de nuestro campo de trabajo. que se sale de nuestro conocimiento de trabajo")} estado={false}/>
            <Button text="Evaluación" onClick={() => alert("Funcionalidad fuera del alcance de nuestro campo de trabajo. que se sale de nuestro conocimiento de trabajo")} estado={false}/>
            <Button text="Logs" onClick={() => alert("Funcionalidad fuera del alcance de nuestro campo de trabajo. que se sale de nuestro conocimiento de trabajo")} estado={false}/>
          </nav>
